        ...
        while True:
            ...
            if (pos[0] >=  p2_s[0] and pos[0] <= p3_s[0] and pos[1] >= p2_s[1] and pos[1] <= p6_s[1]) \
                ...
                if flag:
                    ...
                    pygame.display.update()
                    flag = False
                self.motion = ON_LEVELS
            else:
                self.motion = NOT


            if self.motion is ON_START and self.pr_motion is not ON_START:
                ...
                self.pr_motion = ON_START

            if self.motion is ON_LEVELS and self.pr_motion is not ON_LEVELS:
                ...
                self.pr_motion = ON_LEVELS

            if self.motion is NOT and self.pr_motion is not NOT:
